...
export default function SpanishPage() {
  return (
    <div className="min-h-screen bg-[#F1F9F4]" dir="ltr">
      <main className="mx-auto flex max-w-lg flex-col items-center px-6 py-10 text-center sm:py-14">
        ...
        <h1 className="mb-5 text-3xl font-bold leading-snug text-[#299470] sm:text-4xl">
          Clínica de Calgary para visitas médicas
        </h1>

        <p className="mb-6 max-w-md text-lg font-medium leading-relaxed text-[#050505] sm:text-xl">
          Abierto 7 días a la semana hasta las 11 p.m., incluidos fines de semana y días festivos
        </p>

        <h2 className="mb-5 text-2xl font-bold text-[#299470] sm:text-3xl">
          Médicos y médicas que hablan español
        </h2>

        <p className="mb-10 text-xl font-bold text-[#303030] sm:text-2xl">Reserve una cita ahora</p>

        <div className="flex w-full flex-col items-center gap-12">
          <ContactButtons />
          <ClinicVideo src="/spanishvideo1.mp4" poster="/spanish1.png" />
          <ContactButtons />
          <ClinicVideo src="/spanishvideo2.mp4" poster="/spanish2.png" />
          <ContactButtons />
        </div>
      </main>
    </div>
