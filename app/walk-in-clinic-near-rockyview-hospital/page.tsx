...
export default function RockyviewHospitalPage() {
  const localBusinessSchema = generateLocalBusinessSchema({ ...CLINIC_DATA, description: "Walk-in clinic serving Calgary including Rockyview area. Open until 11 PM daily." });
  const benefits = ["Serving Calgary including Rockyview area", "Walk-in service — no appointment needed", "Average wait time under 30 minutes", "Open until 11 PM every day", "Free parking available"];
