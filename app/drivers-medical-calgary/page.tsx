            ...
            <div className="grid md:grid-cols-2 gap-18 items-center">
              ...
              <div>
                ...
                <Button size="lg" className="bg-[#299470] hover:bg-[#2D7B6F] text-white text-lg" asChild>
                    <Link href="/walk-in-clinic"><img src="/images/driver-medical/walking-outline.svg" alt="Register as a new patient" className="w-5 h-5" />Walk In for Driver's Medical</Link>
                  </Button>
                  <Button
                    size="lg"
                    variant="outline"
