...
import bg_img from "@/public/images/major-sub/south-we-help.png";
import wait_img from "@/public/images/hospital-wait-times/wait-times-reception.png";
import whyChoose_img from "@/public/images/major-sub/rocky-skip-hospital.png";
import new_img from "@/public/images/major-sub/foothill-why-great.png";

export const metadata: Metadata = {
  title: "Walk-In Clinic SE Calgary | Open Until 11 PM | No Appointment Needed",
  description: "Looking for a walk-in clinic in SE Calgary? Open 7 days until 11 PM. Same-day care from licensed family doctors. No appointment required.",
  keywords: ["walk in clinic se calgary", "se calgary walk-in clinic", "same day doctor se calgary", "no appointment clinic se calgary"],
  alternates: {
    canonical: "https://nowmedical.ca/walk-in-clinic-se-calgary"
  }
};

export default function SECalgaryClinicPage() {
  const whyChooseItems = [
    ...
    { text: "Convenient alternative to hospital emergency wait times" },
  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        {
          question: "Is this a walk-in clinic serving SE Calgary?",
          answer: "Yes. We provide walk-in medical care for residents of Mahogany, Auburn Bay, Cranston, Seton, Copperfield, and surrounding southeast Calgary communities."
        }
      ]
    }
  ];
  ...
  const localBusinessSchema = generateLocalBusinessSchema({
    ...CLINIC_DATA,
    description: "Walk-in clinic serving SE Calgary. Same-day care for Mahogany, Auburn Bay, Cranston, Seton, Copperfield. Open until 11 PM daily."
  });
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Walk-In Clinic SE Calgary",
                "item": "https://nowmedical.ca/walk-in-clinic-se-calgary"
              }
            ]
          })
        }}
...
No Appointment Needed</span>
                  ...
                  <p className="text-base text-[#303030] mb-4">
                    ...
                    same-day medical care for residents of <b>Mahogany, Auburn Bay, Cranston, Seton, Copperfield,</b> and surrounding southeast communities.
                  </p>
                  <p className="text-base text-[#303030] mb-4">
                    We are <b>open 7 days a week until 11 PM.</b> No appointment is required.
                  </p>
                  <p className="text-base text-[#303030] mb-4">
                    SE Calgary patients choose walk-in care instead of waiting in emergency departments such as South Health Campus.
                  </p>
                ...
                <div className="flex justify-center items-center lg:ml-8">
                  <iframe
                    ...
                    title="Now Medical Clinic SE Calgary"
                    frameBorder="0"
          ...
          {/* Why SE Calgary Patients Choose Us */}
          <WhyChooseSection
            title="Why SE Calgary"
            title_2=""
            ...
            order="order-last"
            IsDot={false}
            para_after="Our clinic provides accessible after-hours medical care for families and professionals across southeast Calgary."
            both_btn="flex pt-7"
          ...
          <WhyChooseSection
            ...
            para_after="A walk-in clinic may provide faster access than hospital emergency departments."
          ...
          {/* Convenient Access From SE Calgary */}
          <WhyChooseSection
            title="Convenient Access"
            title_2=""
            subtitle="From SE Calgary"
            para="Our clinic is easily accessible via:"
            items={[
              { text: "Deerfoot Trail" },
              { text: "Stoney Trail" },
              { text: "Seton Boulevard" }
            ]}
            para_after="Patients traveling from Mahogany and Auburn Bay can typically reach our clinic within a reasonable drive depending on traffic conditions."
            image={wait_img.src}
            h2_color_1='text-[#299470]'
            h2_sub_color='text-[#303030]'
            IsDot={false}
          ...
          <FAQSection
            ...
            subtitle="Walk-In Clinic SE Calgary"
          ...
          {/* CTA Banner */}
          <BottomCallAction
            title='Walk-In Clinic SE Calgary | '
            title_2="Open 7 Days Until 11 PM"
            description="Looking for a walk-in clinic in SE Calgary? Same-day care from licensed family doctors. No appointment required. Open 7 days until 11 PM. Call"
