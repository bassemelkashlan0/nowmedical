...
import wait_img from "@/public/images/hospital-wait-times/wait-times-open.png";
import whyChoose_img from "@/public/images/major-sub/foothill-why-great.png";


export const metadata: Metadata = {
  title: "Walk-In Clinic NW Calgary | Open Until 11 PM | No Appointment Needed",
  description: "Looking for a walk-in clinic in NW Calgary? Open 7 days until 11 PM. Same-day care from licensed family doctors. No appointment required.",
  keywords: ["walk in clinic nw calgary", "nw calgary walk-in clinic", "same day doctor nw calgary", "no appointment clinic nw calgary"],
  alternates: {
    canonical: "https://nowmedical.ca/walk-in-clinic-nw-calgary"
  } 
};

export default function NWCalgaryClinicPage() {
  ...
  const commonConditions = [
    ...
    { text: "Skin conditions and allergic reactions" },
  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        {
          question: "Is this a walk-in clinic serving NW Calgary?",
          answer: "Yes. We provide walk-in medical care for residents of Tuscany, Crowfoot, Sage Hill, Evanston, and surrounding northwest Calgary communities."
        }
      ]
    }
  ];
  ...
  const localBusinessSchema = generateLocalBusinessSchema({
    ...CLINIC_DATA,
    description: "Walk-in clinic serving NW Calgary. Same-day care for Tuscany, Crowfoot, Sage Hill, Evanston, Nolan Hill. Open until 11 PM daily."
  });
    ...
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Walk-In Clinic NW Calgary",
                "item": "https://nowmedical.ca/walk-in-clinic-nw-calgary"
              }
            ]
          })
        }}
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1">
              ...
              <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                <div>
                  <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-4">
                    <span className="text-[#299470]">Walk-In Clinic Serving NW Calgary</span>
                    <br />
                    <span className="text-[#303030]">Open 7 Days Until 11 PM</span>
                    <br />
                    <span className="text-[#303030]">Including Weekends and Holidays</span>
                    <br />
                    <span className="text-[#303030] text-2xl lg:text-3xl mt-6 leading-snug block font-semibold">Same-Day Medical Care for Northwest Calgary Residents</span>
                  </h1>

                  <p className="text-base text-[#303030] mb-4">
                    If you are searching for a walk-in clinic in <b>NW Calgary,</b> Now Medical Clinic provides
                    same-day medical care for residents of <b>Tuscany, Crowfoot, Sage Hill, Evanston, Nolan Hill,</b> and surrounding northwest communities.
                  </p>
                  <p className="text-base text-[#303030] mb-4">
                    We are <b>open 7 days a week until 11 PM.</b> No appointment is required.
                  </p>
                  <p className="text-base text-[#303030] mb-4">
                    NW Calgary residents choose walk-in care instead of waiting in hospital emergency departments such as Foothills Medical Centre.
                  </p>
                ...
                <div className="flex justify-center items-center lg:ml-8">
                  <iframe
                    ...
                    title="Now Medical Clinic NW Calgary"
                    frameBorder="0"
          ...
          {/* Why NW Calgary Patients Choose Us */}
          <WhyChooseSection
            title="Why NW Calgary"
            title_2=""
            ...
            order="order-last"
            IsDot={false}
            para_after="Our clinic provides convenient after-hours access for families and working professionals across northwest Calgary."
            both_btn="flex pt-7"
          ...
          <WhyChooseSection
            ...
            para_after="A walk-in clinic may provide faster access than emergency services."
          ...
          {/* Convenient Access From NW Calgary */}
          <WhyChooseSection
            title="Convenient Access"
            title_2=""
            subtitle="From NW Calgary"
            para="Our clinic is easily accessible via:"
            items={[
              { text: "Stoney Trail" },
              { text: "Shaganappi Trail" },
              { text: "Crowchild Trail" }
            ]}
            para_after="Patients traveling from Tuscany, Crowfoot, and Sage Hill can typically reach our clinic within a reasonable drive depending on traffic conditions."
            image={why_img.src}
            h2_color_1='text-[#299470]'
            h2_sub_color='text-[#303030]'
            IsDot={false}
          ...
          <FAQSection
            ...
            subtitle="Walk-In Clinic NW Calgary"
          ...
          {/* CTA Banner */}
          <BottomCallAction
            title='Walk-In Clinic NW Calgary | '
            title_2="Open 7 Days Until 11 PM"
            description="Looking for a walk-in clinic in NW Calgary? Same-day care from licensed family doctors. No appointment required. Open 7 days until 11 PM. Call"
