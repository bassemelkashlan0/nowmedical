...
export default function SouthHealthCampusPage() {
  const localBusinessSchema = generateLocalBusinessSchema({ ...CLINIC_DATA, description: "Walk-in clinic serving Calgary including South Health Campus area. Open until 11 PM daily." });
  const benefits = ["Serving Calgary including South Health area", "Walk-in service — no appointment", "Average wait under 30 minutes", "Open until 11 PM daily", "Free parking"];
