...
export function LiveStatusBanner() {
  ...
  return (
    <div className={`sticky w-full mx-auto top-[64.5px] sm:top-20 md:top-[81px] z-40 ${isActive ? "bg-[#A7D3C4]" : "bg-red-200"}`}>
      <div className="container py-3 sm:py-5 md:py-7 px-4 sm:px-6">
        <div className="flex flex-row sm:grid sm:grid-cols-3 gap-2 sm:gap-4 md:gap-6 items-center flex-wrap">
          {/* Walk-in Live Status Section - Left Column */}
          <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
          ...
          {isActive ? (
            <div className="flex flex-col items-center gap-2 sm:gap-3 md:gap-4 flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-[14px] font-bold  text-[#050505] whitespace-nowrap">
                  Short Wait
                </span>
              </div>
