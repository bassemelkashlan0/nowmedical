...
export default function FindUsSection({
  ...
  return (
    <section className={"py-[54px] " + (bgColor ? bgColor : "bg-[#F4FBF8]")}>
      <div className="container mx-auto max-w-7xl">
        <h2 className="text-5xl text-[#303030] font-bold text-center mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-0 items-center">
          ...
          {/* Info */}
          <div className="w-full md:w-1/2 flex flex-col gap-6 justify-center md:pl-12 mt-10 md:mt-0">
            {/* Address */}
            <div className="flex items-start gap-5 mb-2">
              ...
              <div>
                <div className="text-3xl text-[#303030] font-medium mb-1">Address</div>
            ...
            <div className="flex items-start gap-5 mb-2">
              ...
              <div>
                <div className="text-3xl text-[#303030] font-medium mb-1">Hours</div>
            ...
            <div className="flex items-start gap-5 mb-2">
              ...
              <div>
                <div className="text-3xl text-[#303030] font-medium mb-1">Phone</div>
            ...
            {showFreeParking && (
              <div className="flex items-start gap-5 mb-2">
                ...
                <div>
                  <div className="text-3xl text-[#303030] font-medium mb-1">
